                ...
                <table className="w-full text-left text-[11px] md:text-xs text-gray-600">
                    <thead className="bg-gray-50 text-gray-700 font-semibold uppercase tracking-wider">
                        <tr>
                            ...
                            <th className="p-4">Tipo de Agenda</th>
                    ...
                    <tbody className="divide-y divide-gray-100">
                        {currentItems.map((req) => (
                            <tr key={req.id} className={clsx(
                                ...
                                <td className="p-4 align-top">
                                    <span className="inline-block px-2 py-0.5 bg-gray-100 text-gray-700 border border-gray-200 rounded text-[10px] font-semibold uppercase whitespace-nowrap">
                                        {req.categoryType || '-'}
                                    </span>
                                </td>
                                <td className="p-4 align-top">
