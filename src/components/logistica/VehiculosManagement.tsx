...
import type { Vehiculo } from '../../data/logistica/types';
import { VEHICULOS as INITIAL_VEHICULOS } from '../../data/logistica/mockData';
import { required, minLength, maxLength, patente as validatePatente, minNumber, maxNumber, validate } from '../../utils/logistica/validation';
import Toast from './Toast';
import { getVehiculosFirebase, addVehiculoFirebase, updateVehiculoFirebase, deleteVehiculoFirebase } from '@/app/logistica/actions';
