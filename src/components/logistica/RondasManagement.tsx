...
import { POSTAS, VEHICULOS, PERSONAL } from '../../data/logistica/mockData';
import type { Ronda, Posta, Vehiculo, Personal, SolicitudSalida } from '../../data/logistica/types';
import { getSolicitudesFirebase, updateSolicitudFirebase, deleteSolicitudFirebase, getRondasFirebase, addRondaFirebase, updateRondaFirebase, deleteRondaFirebase } from '@/app/logistica/actions';
import { TIPO_CONFIG } from '../../data/logistica/config';
import { required, validate, timeRange } from '../../utils/logistica/validation';
