...
import { getSolicitudesFirebase, deleteSolicitudFirebase, getPostasFirebase } from '@/app/logistica/actions';
import type { SolicitudSalida, Posta } from '../../data/logistica/types';
