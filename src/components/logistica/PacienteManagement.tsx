...
import type { Paciente, Posta } from '../../data/logistica/types';
import { required, validate, minLength } from '../../utils/logistica/validation';
import Toast from './Toast';
import { getPacientesFirebase, addPacienteFirebase, updatePacienteFirebase, deletePacienteFirebase, getPostasFirebase } from '@/app/logistica/actions';
